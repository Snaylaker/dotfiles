      ...
      require("mason-lspconfig").setup({
        handlers = {
          function(server_name)
            ...
            -- Modify this part to include a check for 'tsserver'
            if server_name == "tsserver" then
              local on_attach_original = server.on_attach
              server.on_attach = function(client, bufnr)
                -- Disable document formatting
                client.server_capabilities.documentFormattingProvider = false
                client.server_capabilities.documentRangeFormattingProvider = false

                -- Call any previously defined on_attach function
            ...
            -- Setup the server with modified settings
...
vim.keymap.set(
  ...
  { noremap = true, silent = true, desc = "[F]ind Tmux Session" }
)
